        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://amsc-performance.vercel.app',
              logo: 'https://amsc-performance.vercel.app/images/amsc-logo-hero.png',
              image: 'https://amsc-performance.vercel.app/images/amsc-logo-hero.png',
              address: {
                '@type': 'PostalAddress',
                addressCountry: 'KE',
              },
