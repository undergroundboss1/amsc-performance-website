        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "frame-src https://tally.so https://payment.intasend.com https://checkout.paystack.com",
              "connect-src 'self' https://tally.so https://w.behold.so https://*.instagram.com https://*.cdninstagram.com https://*.supabase.co https://payment.intasend.com https://api.paystack.co",
              "media-src 'self'",
              "object-src 'none'",
              "base-uri 'self'",
